...
export default () => {
    ...
    return (
        <div className="relative max-w-xs px-4 text-base ">
            <button ref={selectMenuRef} className="flex items-center justify-between gap-2 w-full px-3 py-2 text-gray-600 bg-white border  rounded-full shadow-md outline-none hover:bg-gray-100"
                aria-haspopup="true"
                aria-expanded="true"
            ...
            >
                <div className="flex items-center gap-x-1 text-base">
                    Sort by: <span className={`w-2 h-2 rounded-full ${selectedItem.item[1]}`}></span>
                        ...
                        <ul className="absolute w-full mt-3 overflow-y-auto bg-white border rounded-md shadow-sm max-h-64" role="listbox">
                            {
                                menuItems.map((el, idx) => (
                                    <li
                                        ...
                                        className={`${selectedItem.idx == idx ? 'text-blue-600 bg-blue-50' : ''} flex items-center justify-between gap-2 px-3 cursor-default py-2 duration-150 text-gray-500 hover:text-blue-600 hover:bg-blue-50`}
                                    >
