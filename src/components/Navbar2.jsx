        ...
        <nav className="sticky top-0 border-b bg-white z-20 shadow-md">
            <div className="bg-white flex items-center space-x-8 py-2.5 px-4 max-w-screen-xl mx-auto md:px-8">
                ...
                <div className="bg-white flex-1 flex items-center justify-between">
                    <div className={`bg-white absolute z-20 w-3/4 top-16 left-0 p-4 border-b lg:static lg:block lg:border-none ${menuState ? '' : 'hidden'}`}>
                    ...
                    {isAuth ?
                        ...
                        : <div className="flex flex-1 w-1/4 items-center space-x-6 lg:space-x-8">
                            <Link className="my-auto py-1 px-5 rounded-lg font-medium border border-blue-600 text-blue-600 text-center bg-white hover:bg-gray-100 active:bg-white duration-150 block md:py-2 md:inline"
                                to="/login">Log In</Link>

                            <Link className="my-auto py-1 px-5 rounded-lg font-medium text-white text-center bg-blue-600 hover:bg-blue-500 active:bg-blue-700 duration-150 block md:py-2 md:inline"
