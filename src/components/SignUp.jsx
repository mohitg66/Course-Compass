...
export default () => {
    ...
    const submit = async e => {
        confirm("Are you sure you want to submit? You may not be able to change your details later.")
        e.preventDefault();
        const user = {
            username: username,
            password: password,
            ...
            <div className="max-w-sm w-full text-gray-600">
                <div className="text-center pb-8">
                    ...
                    <div className="mt-5 space-y-2">
                        ...
                        <p className="text-center">Already have an account?  <Link to="/login" className="font-medium text-blue-600 hover:text-blue-500">Log In</Link></p>
                    </div>
                </div>
                <form
                    className="space-y-3"
...
// import Degree from './signUp/Degree'
...
//                 >
//                     <div className='flex flex-row gap-x-2 box-content'>
//                     <input
//                             type="name"
//                             required
